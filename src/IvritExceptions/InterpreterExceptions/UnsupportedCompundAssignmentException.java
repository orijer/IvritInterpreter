 ...
 */
public class UnsupportedCompundAssignmentException extends UnsupportedOperationException{
    /**
     * Constructor.
     * @param assignmentType - The type of assignment the user attempted.
     * @param data - the rest of the data in that assignment action.
     */
    public UnsupportedCompundAssignmentException(char assignmentType, String data) {
